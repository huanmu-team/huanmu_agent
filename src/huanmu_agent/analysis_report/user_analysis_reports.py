...
"""
    print("风险预警提示词如下↓：")
    print([{"role": "system", "content": system_msg}]+[{"role": "human", "content": "请你按照上面要求，生成医美客户风险预警与个性化服务建议报告。"}])
    print("风险预警提示词如上↑：")
...
"""
    print("客户信息提示词如下↓：")
    print([{"role": "system", "content": system_prompt}]+[{"role": "human", "content": "请你按照上面要求，生成医美客户信息洞察与接待准备报告。"}])
    print("客户信息提示词如上↑：")
...
"""
    print("AI客服对话风格提示词如下↓：")
    print([{"role": "system", "content": system_msg}]+[{"role": "human", "content": "请你按照上面要求，生成AI客服对话风格分析报告。"}])
    print("AI客服对话风格提示词如上↑：")
