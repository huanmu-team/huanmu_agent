...
from huanmu_agent.prompts import GENERAL_SALES_SYSTEM_PROMPT
...
async def call_model(state: State) -> Dict[str, Any]:
    ...
    def _prepare_system_message():
        ...
        system_prompt_text = GENERAL_SALES_SYSTEM_PROMPT.format(
            system_time=beijing_now,
            agent_name=configuration.agent_name,
            agent_gender=configuration.agent_gender,
            agent_age=configuration.agent_age,
            company_name=configuration.company_name,
            industry=configuration.industry,
            agent_personality=configuration.agent_personality,
            agent_origin=configuration.agent_origin,
            company_city=configuration.company_city,
            agent_experience_years=configuration.agent_experience_years,
            company_address=configuration.company_address,
            service_scope=configuration.service_scope,
            Company_and_Product_Information=configuration.Company_and_Product_Information,
            Conversation_Example=configuration.Conversation_Example,
        )
